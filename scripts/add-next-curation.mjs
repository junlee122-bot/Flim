...
const QUEUE = [
  ...
  },
  {
    slug: "wong-kar-wai",
    title: "왕가위 감독전",
    description: "스텝 프린팅과 네온, 엇갈린 사랑의 시간. 왕가위의 무드.",
    films: [
      { q: "화양연화", y: 2000 },
      { q: "중경삼림", y: 1994 },
      { q: "해피 투게더", y: 1997 },
  ...
  },
  {
    slug: "kurosawa",
    title: "구로사와 아키라",
    description: "활극과 휴머니즘. 세계 영화에 가장 큰 그림자를 드리운 거장.",
    films: [
      { q: "7인의 사무라이", y: 1954 },
      { q: "라쇼몽", y: 1950 },
      { q: "요짐보", y: 1961 },
  ...
  },
  {
    ...
    title: "허우샤오시엔과 대만 뉴웨이브",
    description: "롱테이크로 응시하는 시간과 역사. 대만 영화의 결.",
    films: [
      { q: "비정성시", y: 1989 },
      { q: "동년왕사", y: 1985 },
      { q: "밀레니엄 맘보", y: 2001 },
  ...
  },
  {
    slug: "ozu",
    title: "오즈 야스지로",
    description: "다다미 쇼트와 가족의 시간. 일상의 가장 깊은 곳.",
    films: [
      { q: "동경 이야기", y: 1953 },
      { q: "만춘", y: 1949 },
      { q: "꽁치의 맛", y: 1962 },
  ...
  },
  {
    ...
    title: "이탈리아 네오리얼리즘",
    description: "폐허 위의 거리, 비전문 배우, 삶 그 자체. 전후 이탈리아의 시선.",
    films: [
      { q: "자전거 도둑", y: 1948 },
      { q: "무방비 도시", y: 1945 },
      { q: "움베르토 D", y: 1952 },
  ...
  {
    slug: "studio-a24-recent",
    title: "동시대 호러의 재발견",
    description: "장르의 관습을 비틀어 공포를 다시 쓴 작가들.",
    films: [
      { q: "햄스터", y: 2017 },
      { q: "바바둑", y: 2014 },
      { q: "겟 아웃", y: 2017 },
  ...
  {
    slug: "animation-beyond-ghibli",
    title: "지브리 너머의 애니메이션",
    description: "손그림과 디지털을 넘나드는, 어른을 위한 애니메이션.",
    films: [
      { q: "퍼펙트 블루", y: 1997 },
      { q: "아키라", y: 1988 },
      { q: "스파이더맨: 뉴 유니버스", y: 2018 },
      { q: "월-E", y: 2008 },
      { q: "파프리카", y: 2006 },
    ],
  },
